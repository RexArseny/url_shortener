...
func (x *Status) SetStatus(v string) {
	x.xxx_hidden_Status = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 1)
}

func (x *Status) HasStatus() bool {
	if x == nil {
		return false
	}
...
const file_status_proto_rawDesc = "" +
	"\n" +
	"\fstatus.proto\x12\vproto.model\x1a!google/protobuf/go_features.proto\" \n" +
	"\x06Status\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06statusBLZBgithub.com/RexArseny/url_shortener/internal/app/models/proto/model\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_status_proto_goTypes = []any{
	(*Status)(nil), // 0: proto.model.Status
}
